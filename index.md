...
venue: "November 2019 SWC workshop @TU/Delft"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Susan Branchett, Nicolas Dintzner", "Kees den Heijer"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jacques Flores", "Andre van der Kraan", "Mark Schenk","Sobhan Omranian Khorasani", "Lena Karvovskaya","Kees den Heijer", "Heather Andrews","Esther Plomp", "Yasemin Turkyilmaz","Santosh Ilamparuthi"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-11-13-delft           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite:  76742273205        # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
